...
import sty from "./PlasmicButton.module.css"; // plasmic-import: Mk2LrAAMfItq/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Fxrb0pHgOXY5/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: YkbMSN9iL4_2/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4PFgz)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__wwqci)}
                role={"img"}
              />
            ),
