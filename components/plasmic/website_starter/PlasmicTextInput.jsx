...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: R9fPv4OPw6ne/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: PKAldcy9BYHE/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Fxrb0pHgOXY5/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__aEkcW)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___1XJc6)}
              role={"img"}
            />
          ),
